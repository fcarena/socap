...
//=====================================================================================================
$xHP		= new cHPage("TR.Alertas Dictaminadas", HP_REPORT);
$xL			= new cSQLListas();
$xF			= new cFecha();
$query		= new MQL();
$xAl		= new cAml_alerts();
...
$CamposExtras	= "";
if($conchecking	== true){
	$CamposExtras	= ", `mensaje`, getFechaMXByInt(`fecha_de_checking`) AS `fecha_de_dictamen` ,`notas_de_checking` AS `dictamen` ";
}
