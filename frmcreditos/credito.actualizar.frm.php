...
$xFRM->OButton("TR.Actualizar ESTATUS", "jsaSetEstatus()", $xFRM->ic()->GENERAR, "idacat"  );
...
<script>
	...
	function jsImportarPlanDePagos(){	ogen.w({ url: '../frmcreditos/importar.plan_de_pagos.frm.php?credito=' + idCredito, tab : true }); 	}
	function regenerarPlanDePagos(){ ogen.w({ url: '../frmcreditos/frmcreditosplandepagos.php?r=1&c=' + idCredito + "&s=" + idSocio }); }
	function jsEditarPlan(mPlan){ 	ogen.w({ url: '../frmcreditos/plan_de_pagos.edicion.frm.php?activeplan=true&recibo=' + mPlan, tab:true }); }
