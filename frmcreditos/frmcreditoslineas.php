...
if( ($action == MQL_ADD OR $action == MQL_MOD) AND ($clave != null) ){
	...
	$xFRM->OMoneda("monto_linea", $xTabla->monto_linea()->v(), "TR.monto");
	...
	$idtasa	= $xTabla->tasa()->v() * 100;
	$xFRM->OMoneda("tasa", $idtasa, "TR.TASA_ANUALIZADA");
	...
	$xFRM->OMoneda("monto_hipoteca", $xTabla->monto_hipoteca()->v(), "TR.monto de Garantia");
