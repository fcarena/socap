...
$xFRM->addHElem($xSel->getListaDeCatalogoGenerico("tipo_requisito", "tipo_req", $xTabla->tipo_req()->v())->get("TR.TIPO_DE REQUISITO", true));
...
$xFRM->OMoneda("numero", $xTabla->numero()->v(), "TR.NUMERO");
$xFRM->OText("ruta_validacion", $xTabla->ruta_validacion()->v(), "TR.RUTA VALIDACION");
