...
//=====================================================================================================
$xHP		= new cHPage("TR.REPORTE DE CREDITOS AUTORIZADOS", HP_REPORT);
$xL			= new cSQLListas();
$xF			= new cFecha();
$xQL		= new MQL();
...
$sql			= $xL->getListaDeCreditosAutorizados(false, false, true, true, true, $FechaInicial, $FechaFinal, false);
$titulo			= $xHP->getTitle();
...
$xT->setFootSum(array( 7 => "monto_solicitado", 16 => "monto_autorizado"));
