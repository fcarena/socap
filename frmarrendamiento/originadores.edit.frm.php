...
//=====================================================================================================
$xHP		= new cHPage("TR.EDITAR ORIGINADORES", HP_FORM);
$xQL		= new MQL();
$xLi		= new cSQLListas();
$xF			= new cFecha();
...
$xFRM->OHidden("idleasing_originadores", $xTabla->idleasing_originadores()->v(), "TR.IDLEASING ORIGINADORES");
...
//$xSel->getListaDePeriocidadDePago()->get(true)
