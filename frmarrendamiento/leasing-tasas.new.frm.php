...
//=====================================================================================================
$xHP		= new cHPage("TR.AGREGAR TASAS DE ARRENDAMIENTO", HP_FORM);
$xQL		= new MQL();
$xLi		= new cSQLListas();
$xF			= new cFecha();
...
$xFRM->OHidden("idleasing_tasas", "NULL");
...
$xFRM->OMoneda("tasa_ofrecida", $xTabla->tasa_ofrecida()->v(), "TR.TASA");

$xFRM->OMoneda("comision_apertura", $xTabla->comision_apertura()->v(), "TR.COMISION_POR_APERTURA");
