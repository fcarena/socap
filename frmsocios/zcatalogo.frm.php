...
//=====================================================================================================
$xHP		= new cHPage("TR.Editar zclasificacion", HP_GRID);
$xF			= new cFecha();
$xL			= new cLang();

	$xTabla				= new cPersonas_zclasificacion();
	...
	$mGridWhere			= "";
	$mGridProp			= array(
							"idpersonas_zclasificacion" => "TR.zclasificacion,true,100",
							"descripcion_zclasificacion" => "TR.descripcion,true,200",
							"zclasificacion_etiquetas" => "TR.etiquetas,true,300",
						);
	//===========================================================================================================
