...
//=====================================================================================================
$xHP		= new cHPage("TR.Editar TIPO_MEMBRESIA", HP_GRID);
$xF			= new cFecha();
$xL			= new cLang();

	$xTabla				= new cPersonas_membresia_tipo();
	...
	$mGridWhere			= "";
	$mGridProp			= array(
	"idpersonas_membresia_tipo" => "TR.CLAVE,true,80",
	"descripcion_membresia_tipo" => "TR.NOMBRE,true,300"
						);
	//===========================================================================================================
