...
//=====================================================================================================
$xHP		= new cHPage("TR.Editar yclasificacion", HP_GRID);
$xF			= new cFecha();
$xL			= new cLang();

	$xTabla				= new cPersonas_yclasificacion();
	...
	$mGridWhere			= "";
	$mGridProp			= array(
							"idpersonas_yclasificacion" => "TR.yclasificacion,true,100",
							"descripcion_yclasificacion" => "TR.descripcion,true,200",
							"yclasificacion_etiquetas" => "TR.etiquetas,true,300",
						);
	//===========================================================================================================
