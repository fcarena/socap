...
class cGeneral_reports {
	private $mCampos	= array(
			...
			"explicacion" => array("N"=>"explicacion","T"=>"MEDIUMTEXT","V"=>"","L"=>0),
			"order_index" => array("N"=>"order_index","T"=>"INT","V"=>"0","L"=>3),
...
class cCreditos_plan_de_pagos {
	private $mCampos	= array(
		"plan_de_pago" => array("N"=>"plan_de_pago","T"=>"INT","V"=>"","L"=>11),
		"clave_de_credito" => array("N"=>"clave_de_credito","T"=>"BIGINT","V"=>"1","L"=>20),
		"numero_de_parcialidad" => array("N"=>"numero_de_parcialidad","T"=>"INT","V"=>"1","L"=>11),
		"fecha_de_pago" => array("N"=>"fecha_de_pago","T"=>"DATE","V"=>"","L"=>0),
		"capital" => array("N"=>"capital","T"=>"DOUBLE","V"=>"0.00","L"=>29),
		"interes" => array("N"=>"interes","T"=>"FLOAT","V"=>"0.00","L"=>25),
		"impuesto" => array("N"=>"impuesto","T"=>"FLOAT","V"=>"0.00","L"=>25),
		"otros" => array("N"=>"otros","T"=>"FLOAT","V"=>"0.00","L"=>25),
		"otros_codigo" => array("N"=>"otros_codigo","T"=>"INT","V"=>"0","L"=>11),
		"saldo_inverso" => array("N"=>"saldo_inverso","T"=>"DOUBLE","V"=>"0.00","L"=>33),
		"sucursal" => array("N"=>"sucursal","T"=>"VARCHAR","V"=>"matriz","L"=>20),
		"ahorro" => array("N"=>"ahorro","T"=>"FLOAT","V"=>"0.00","L"=>25),
...
class cCreditos_lineas {
	private $mCampos	= array(
			"idcreditos_lineas" => array("N"=>"idcreditos_lineas","T"=>"INT","V"=>"","L"=>10),
			"numero_socio" => array("N"=>"numero_socio","T"=>"BIGINT","V"=>"1","L"=>20),
			"monto_linea" => array("N"=>"monto_linea","T"=>"DOUBLE","V"=>"0.00","L"=>33),
			"observaciones" => array("N"=>"observaciones","T"=>"VARCHAR","V"=>"","L"=>100),
			"numerohipoteca" => array("N"=>"numerohipoteca","T"=>"VARCHAR","V"=>"","L"=>100),
			"monto_hipoteca" => array("N"=>"monto_hipoteca","T"=>"DOUBLE","V"=>"0.00","L"=>33),
			"fecha_de_vencimiento" => array("N"=>"fecha_de_vencimiento","T"=>"DATE","V"=>"0000-00-00","L"=>0),
			"fecha_de_alta" => array("N"=>"fecha_de_alta","T"=>"DATE","V"=>"0000-00-00","L"=>0),
			...
			"fecha_ultima_operacion" => array("N"=>"fecha_ultima_operacion","T"=>"DATE","V"=>"0000-00-00","L"=>0),
			"saldo_disponible" => array("N"=>"saldo_disponible","T"=>"DOUBLE","V"=>"0.00","L"=>33),
			"oficial_de_credito" => array("N"=>"oficial_de_credito","T"=>"INT","V"=>"99","L"=>11),
			"fecha_de_cancelacion" => array("N"=>"fecha_de_cancelacion","T"=>"DATE","V"=>"0000-00-00","L"=>0),
			"razones_de_cancelacion" => array("N"=>"razones_de_cancelacion","T"=>"VARCHAR","V"=>"","L"=>100),
			"tasa" => array("N"=>"tasa","T"=>"FLOAT","V"=>"0.000","L"=>13),
...
class cCreditos_tipoconvenio {
	private $mCampos	= array(
			...
			"creditos_mayores_a" => array("N"=>"creditos_mayores_a","T"=>"DOUBLE","V"=>"0.00","L"=>33),
			...
			"maximo_otorgable" => array("N"=>"maximo_otorgable","T"=>"DOUBLE","V"=>"0.00","L"=>33),
			...
			"omitir_seguimiento" => array("N"=>"omitir_seguimiento","T"=>"INT","V"=>"0","L"=>4),
...
class cCreditos_montos {
	private $mCampos	= array(
			"idcreditos_montos" => array("N"=>"idcreditos_montos","T"=>"INT","V"=>"","L"=>11),
			"clave_de_credito" => array("N"=>"clave_de_credito","T"=>"BIGINT","V"=>"0","L"=>20),
			"sucursal" => array("N"=>"sucursal","T"=>"VARCHAR","V"=>"matriz","L"=>20),
			"marca_tiempo" => array("N"=>"marca_tiempo","T"=>"INT","V"=>"0","L"=>10),
			"marca_acceso" => array("N"=>"marca_acceso","T"=>"INT","V"=>"0","L"=>10),
			"interes_n_dev" => array("N"=>"interes_n_dev","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"interes_n_pag" => array("N"=>"interes_n_pag","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"interes_m_dev" => array("N"=>"interes_m_dev","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"interes_m_pag" => array("N"=>"interes_m_pag","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"interes_n_corr" => array("N"=>"interes_n_corr","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"interes_m_corr" => array("N"=>"interes_m_corr","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"cargos_cbza" => array("N"=>"cargos_cbza","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"imptos_int_n" => array("N"=>"imptos_int_n","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"imptos_int_m" => array("N"=>"imptos_int_m","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"imptos_otros" => array("N"=>"imptos_otros","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"penas" => array("N"=>"penas","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"bonificaciones" => array("N"=>"bonificaciones","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"capital_exigible" => array("N"=>"capital_exigible","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"f_primer_atraso" => array("N"=>"f_primer_atraso","T"=>"DATE","V"=>"0000-00-00","L"=>0),
			"f_ultimo_atraso" => array("N"=>"f_ultimo_atraso","T"=>"DATE","V"=>"0000-00-00","L"=>0),
			"otros1_id" => array("N"=>"otros1_id","T"=>"INT","V"=>"0","L"=>5),
			"otros1_m" => array("N"=>"otros1_m","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"otros2_id" => array("N"=>"otros2_id","T"=>"INT","V"=>"0","L"=>5),
			"otros2_m" => array("N"=>"otros2_m","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"otros_nc" => array("N"=>"otros_nc","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"usuario" => array("N"=>"usuario","T"=>"INT","V"=>"0","L"=>6),
			"guardar" => array("N"=>"guardar","T"=>"INT","V"=>"0","L"=>2),
			"t_iva_int_n" => array("N"=>"t_iva_int_n","T"=>"FLOAT","V"=>"0.000","L"=>17),
			"t_iva_m" => array("N"=>"t_iva_m","T"=>"FLOAT","V"=>"0.000","L"=>17),
			"t_iva_o" => array("N"=>"t_iva_o","T"=>"FLOAT","V"=>"0.000","L"=>17),
			"otros_si" => array("N"=>"otros_si","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"dispocision" => array("N"=>"dispocision","T"=>"DOUBLE","V"=>"0.00","L"=>33),
			"saldo_plan" => array("N"=>"saldo_plan","T"=>"DOUBLE","V"=>"0.00","L"=>33),
			"abonos_ops" => array("N"=>"abonos_ops","T"=>"DOUBLE","V"=>"0.00","L"=>33),
			"periodo_min" => array("N"=>"periodo_min","T"=>"INT","V"=>"0","L"=>5),
			"periodo_max" => array("N"=>"periodo_max","T"=>"INT","V"=>"0","L"=>5),
			"periodo_last" => array("N"=>"periodo_last","T"=>"INT","V"=>"0","L"=>5),
			"bon_int" => array("N"=>"bon_int","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"bon_mora" => array("N"=>"bon_mora","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"bon_otros" => array("N"=>"bon_otros","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"sdo_exig_fut" => array("N"=>"sdo_exig_fut","T"=>"DOUBLE","V"=>"0.00","L"=>33),
			"sdo_exig_act" => array("N"=>"sdo_exig_act","T"=>"DOUBLE","V"=>"0.00","L"=>33),
...
class cCreditos_etapas {
	private $mCampos	= array("idcreditos_etapas" => array("N"=>"idcreditos_etapas","T"=>"INT","V"=>"","L"=>11),"descripcion" => array("N"=>"descripcion","T"=>"VARCHAR","V"=>"","L"=>50),);
	function __construct($campos = false){ if(is_array($campos)){ $this->mCampos = $campos; } }
...
class cCreditos_productos_req {
	private $mCampos	= array("idcreditos_productos_req" => array("N"=>"idcreditos_productos_req","T"=>"INT","V"=>"","L"=>11),"producto" => array("N"=>"producto","T"=>"INT","V"=>"","L"=>8),"tipo_req" => array("N"=>"tipo_req","T"=>"INT","V"=>"","L"=>4),"descripcion" => array("N"=>"descripcion","T"=>"VARCHAR","V"=>"","L"=>50),"numero" => array("N"=>"numero","T"=>"INT","V"=>"1","L"=>4),"ruta_validacion" => array("N"=>"ruta_validacion","T"=>"VARCHAR","V"=>"../svc/validad.svc.php","L"=>150),"escore" => array("N"=>"escore","T"=>"FLOAT","V"=>"0.000","L"=>13),"etapa" => array("N"=>"etapa","T"=>"VARCHAR","V"=>"","L"=>15),"requerido" => array("N"=>"requerido","T"=>"INT","V"=>"1","L"=>2),"clave" => array("N"=>"clave","T"=>"INT","V"=>"0","L"=>6),);
	function __construct($campos = false){ if(is_array($campos)){ $this->mCampos = $campos; } }
...
/*	ORM: Tabla:	originacion_leasing	-	Generado:	[08/11/2016 11:23]	*/
...
class cSocios_memotipos {
	private $mCampos	= array(
			"tipo_memo" => array("N"=>"tipo_memo","T"=>"INT","V"=>"","L"=>4),
			"descripcion_memo" => array("N"=>"descripcion_memo","T"=>"VARCHAR","V"=>"","L"=>45)
...
class cSocios_memo {
	private $mCampos	= array(
			...
			"archivado" => array("N"=>"archivado","T"=>"INT","V"=>"1","L"=>2),
...
class cSocios_viviendatipo {
	private $mCampos	= array(
			"idsocios_viviendatipo" => array("N"=>"idsocios_viviendatipo","T"=>"INT","V"=>"0","L"=>4),
			"descripcion_viviendatipo" => array("N"=>"descripcion_viviendatipo","T"=>"VARCHAR","V"=>"","L"=>45),
			"tipo_domicilio" => array("N"=>"tipo_domicilio","T"=>"INT","V"=>"0","L"=>4),
...
class cOperaciones_recibos {
	private $mCampos	= array(
			...
			"total_operacion" => array("N"=>"total_operacion","T"=>"DOUBLE","V"=>"0.00","L"=>33),
			"idusuario" => array("N"=>"idusuario","T"=>"INT","V"=>"99","L"=>4),
			...
			"unidades_en_moneda" => array("N"=>"unidades_en_moneda","T"=>"DOUBLE","V"=>"0.0000","L"=>33),
			...
			"periodo_de_documento" => array("N"=>"periodo_de_documento","T"=>"INT","V"=>"0","L"=>4),
			"cuenta_bancaria" => array("N"=>"cuenta_bancaria","T"=>"BIGINT","V"=>"0","L"=>20),
			"montohist" => array("N"=>"montohist","T"=>"DOUBLE","V"=>"0.00","L"=>33),
...
class cSocios_genero {
	private $mCampos	= array(
			"idsocios_genero" => array("N"=>"idsocios_genero","T"=>"INT","V"=>"0","L"=>4),
			"descripcion_genero" => array("N"=>"descripcion_genero","T"=>"VARCHAR","V"=>"","L"=>45),
			"genero" => array("N"=>"genero","T"=>"INT","V"=>"0","L"=>4),
...
class cSocios_patrimoniotipo {
	private $mCampos	= array(
			"idsocios_patrimoniotipo" => array("N"=>"idsocios_patrimoniotipo","T"=>"INT","V"=>"0","L"=>4),
			"descripcion_patrimoniotipo" => array("N"=>"descripcion_patrimoniotipo","T"=>"VARCHAR","V"=>"","L"=>65),
			"subclasificacion" => array("N"=>"subclasificacion","T"=>"INT","V"=>"1","L"=>4),
			"tipo_patrimonio" => array("N"=>"tipo_patrimonio","T"=>"INT","V"=>"","L"=>4),
...
class cSocios_patrimonio {
	private $mCampos	= array(
			"idsocios_patrimonio" => array("N"=>"idsocios_patrimonio","T"=>"INT","V"=>"","L"=>10),
			"socio_patrimonio" => array("N"=>"socio_patrimonio","T"=>"BIGINT","V"=>"0","L"=>20),
			"tipo_patrimonio" => array("N"=>"tipo_patrimonio","T"=>"INT","V"=>"0","L"=>4),
			"monto_patrimonio" => array("N"=>"monto_patrimonio","T"=>"FLOAT","V"=>"0.00","L"=>25),
			"afectacion_patrimonio" => array("N"=>"afectacion_patrimonio","T"=>"FLOAT","V"=>"0.00","L"=>25),
			"fecha_expiracion" => array("N"=>"fecha_expiracion","T"=>"DATE","V"=>"0000-00-00","L"=>0),
			"observaciones" => array("N"=>"observaciones","T"=>"VARCHAR","V"=>"","L"=>100),
			"descripcion" => array("N"=>"descripcion","T"=>"VARCHAR","V"=>"","L"=>100),
			"documento_presentado" => array("N"=>"documento_presentado","T"=>"VARCHAR","V"=>"","L"=>45),
			"solicitud_relacionada" => array("N"=>"solicitud_relacionada","T"=>"BIGINT","V"=>"1","L"=>20),
			"estatus_actual" => array("N"=>"estatus_actual","T"=>"INT","V"=>"99","L"=>4),
			"codigo" => array("N"=>"codigo","T"=>"INT","V"=>"1","L"=>10),
			"sucursal" => array("N"=>"sucursal","T"=>"VARCHAR","V"=>"MATRIZ","L"=>10),
			"eacp" => array("N"=>"eacp","T"=>"VARCHAR","V"=>"EN_TRAMITE","L"=>20),
			"idusuario" => array("N"=>"idusuario","T"=>"INT","V"=>"","L"=>10),
...
class cPersonas_datos_colegiacion {
	private $mCampos	= array(
			"idpersonas_datos_colegiacion" => array("N"=>"idpersonas_datos_colegiacion","T"=>"INT","V"=>"","L"=>11),
			"clave_de_persona" => array("N"=>"clave_de_persona","T"=>"BIGINT","V"=>"","L"=>25),
			"dia_de_pago" => array("N"=>"dia_de_pago","T"=>"VARCHAR","V"=>"","L"=>10),
			"tipo_de_lugar_de_pago" => array("N"=>"tipo_de_lugar_de_pago","T"=>"INT","V"=>"1","L"=>4),
			"tipo_de_afiliacion" => array("N"=>"tipo_de_afiliacion","T"=>"INT","V"=>"0","L"=>6),
			"datos_de_emergencia" => array("N"=>"datos_de_emergencia","T"=>"VARCHAR","V"=>"","L"=>100),
			"grado_academico" => array("N"=>"grado_academico","T"=>"INT","V"=>"0","L"=>4),
			"numero_de_colegiacion" => array("N"=>"numero_de_colegiacion","T"=>"VARCHAR","V"=>"0","L"=>15),
...
class cPersonas_checklist {
	private $mCampos	= array(
			"idpersonas_checklist" => array("N"=>"idpersonas_checklist","T"=>"INT","V"=>"","L"=>11),
			"clave_de_persona" => array("N"=>"clave_de_persona","T"=>"BIGINT","V"=>"0","L"=>20),
			"fecha_de_checklist" => array("N"=>"fecha_de_checklist","T"=>"DATE","V"=>"","L"=>0),
			"entregaa" => array("N"=>"entregaa","T"=>"INT","V"=>"0","L"=>2),
			"entregab" => array("N"=>"entregab","T"=>"INT","V"=>"0","L"=>2),
			"entregac" => array("N"=>"entregac","T"=>"INT","V"=>"0","L"=>2),
			"entregad" => array("N"=>"entregad","T"=>"INT","V"=>"0","L"=>2),
			"entregae" => array("N"=>"entregae","T"=>"INT","V"=>"0","L"=>2),
			"entregaf" => array("N"=>"entregaf","T"=>"INT","V"=>"0","L"=>2),
			"entregag" => array("N"=>"entregag","T"=>"INT","V"=>"0","L"=>2),
			"entregah" => array("N"=>"entregah","T"=>"INT","V"=>"0","L"=>2),
			"entregai" => array("N"=>"entregai","T"=>"INT","V"=>"0","L"=>2),
			"entregaj" => array("N"=>"entregaj","T"=>"INT","V"=>"0","L"=>2),
...
class cPersonas_morales_anx {
	private $mCampos	= array(
			"idpersonas_morales_anx" => array("N"=>"idpersonas_morales_anx","T"=>"INT","V"=>"","L"=>11),
			"persona" => array("N"=>"persona","T"=>"BIGINT","V"=>"","L"=>20),
			"idregistro_publico" => array("N"=>"idregistro_publico","T"=>"VARCHAR","V"=>"","L"=>20),
			"fecha_de_constitucion" => array("N"=>"fecha_de_constitucion","T"=>"DATE","V"=>"","L"=>0),
			"idacta_constitucion" => array("N"=>"idacta_constitucion","T"=>"VARCHAR","V"=>"","L"=>50),
			"idpoder_representante" => array("N"=>"idpoder_representante","T"=>"VARCHAR","V"=>"","L"=>20),
			"fechapoder_representante" => array("N"=>"fechapoder_representante","T"=>"DATE","V"=>"","L"=>0),
			"nombre_notario" => array("N"=>"nombre_notario","T"=>"VARCHAR","V"=>"","L"=>100),
			"clave_notaria" => array("N"=>"clave_notaria","T"=>"VARCHAR","V"=>"","L"=>20),
			"idregistro1" => array("N"=>"idregistro1","T"=>"VARCHAR","V"=>"","L"=>20),
			"idregistro2" => array("N"=>"idregistro2","T"=>"VARCHAR","V"=>"","L"=>20),
			"activo" => array("N"=>"activo","T"=>"INT","V"=>"0","L"=>2),
			"fecha_de_baja" => array("N"=>"fecha_de_baja","T"=>"DATE","V"=>"","L"=>0),
...
class cPersonas_perfil_transaccional {
	private $mCampos	= array(
			...
			"clave_de_persona" => array("N"=>"clave_de_persona","T"=>"BIGINT","V"=>"1","L"=>20),
			"fecha_de_registro" => array("N"=>"fecha_de_registro","T"=>"BIGINT","V"=>"0","L"=>20),
			"fecha_de_vencimiento" => array("N"=>"fecha_de_vencimiento","T"=>"BIGINT","V"=>"0","L"=>20),
			"clave_de_tipo_de_perfil" => array("N"=>"clave_de_tipo_de_perfil","T"=>"INT","V"=>"0","L"=>11),
			"pais_de_origen" => array("N"=>"pais_de_origen","T"=>"VARCHAR","V"=>"MXN","L"=>6),
			"maximo_de_operaciones" => array("N"=>"maximo_de_operaciones","T"=>"INT","V"=>"0","L"=>11),
			"cantidad_maxima" => array("N"=>"cantidad_maxima","T"=>"DOUBLE","V"=>"0.000","L"=>37),
			"operaciones_calculadas" => array("N"=>"operaciones_calculadas","T"=>"INT","V"=>"0","L"=>6),
			"cantidad_calculada" => array("N"=>"cantidad_calculada","T"=>"DOUBLE","V"=>"0.000","L"=>37),
			"fecha_de_calculo" => array("N"=>"fecha_de_calculo","T"=>"BIGINT","V"=>"0","L"=>20),
			"afectacion" => array("N"=>"afectacion","T"=>"INT","V"=>"0","L"=>3),
			"observaciones" => array("N"=>"observaciones","T"=>"VARCHAR","V"=>"","L"=>100),
			"recurso_origen" => array("N"=>"recurso_origen","T"=>"VARCHAR","V"=>"","L"=>100),
			"recurso_aplicacion" => array("N"=>"recurso_aplicacion","T"=>"VARCHAR","V"=>"","L"=>100),
...
class cGeneral_estados {
	private $mCampos	= array(
			...
			"clave_en_sic" => array("N"=>"clave_en_sic","T"=>"VARCHAR","V"=>"","L"=>8),
			"codigo_postal_inicial" => array("N"=>"codigo_postal_inicial","T"=>"INT","V"=>"0","L"=>11),
			"codigo_postal_final" => array("N"=>"codigo_postal_final","T"=>"INT","V"=>"0","L"=>11),
			"operacion_habilitada" => array("N"=>"operacion_habilitada","T"=>"INT","V"=>"1","L"=>2),
...
class cSistema_programacion_de_avisos {
	private $mCampos	= array(
			...
			"programacion" => array("N"=>"programacion","T"=>"VARCHAR","V"=>"","L"=>100),
			"destinatarios" => array("N"=>"destinatarios","T"=>"TEXT","V"=>"","L"=>0),
			"microformato" => array("N"=>"microformato","T"=>"TEXT","V"=>"","L"=>0),
			"tipo_de_medios" => array("N"=>"tipo_de_medios","T"=>"VARCHAR","V"=>"","L"=>50),
			"intent_check" => array("N"=>"intent_check","T"=>"TEXT","V"=>"","L"=>0),
			"intent_command" => array("N"=>"intent_command","T"=>"TEXT","V"=>"","L"=>0),
...
class cEntidad_calificacion {
	private $mCampos	= array(
			"identidad_calificacion" => array("N"=>"identidad_calificacion","T"=>"INT","V"=>"","L"=>11),
			"tipo_de_objeto" => array("N"=>"tipo_de_objeto","T"=>"INT","V"=>"","L"=>4),
			"clave_de_documento" => array("N"=>"clave_de_documento","T"=>"BIGINT","V"=>"0","L"=>20),
			"fecha_de_revision" => array("N"=>"fecha_de_revision","T"=>"DATE","V"=>"","L"=>0),
			"usuario" => array("N"=>"usuario","T"=>"INT","V"=>"","L"=>6),
			"topico" => array("N"=>"topico","T"=>"VARCHAR","V"=>"","L"=>100),
			"cumple" => array("N"=>"cumple","T"=>"INT","V"=>"","L"=>2),
			"tiempo" => array("N"=>"tiempo","T"=>"INT","V"=>"","L"=>10),
			"vencimiento" => array("N"=>"vencimiento","T"=>"INT","V"=>"","L"=>10),
			"riesgo" => array("N"=>"riesgo","T"=>"FLOAT","V"=>"0.000","L"=>13),
...
class cSocios_relaciones {
	private $mCampos	= array(
			...
			"monto_relacionado" => array("N"=>"monto_relacionado","T"=>"DOUBLE","V"=>"0.00","L"=>33),
			...
			"dato_extra_1" => array("N"=>"dato_extra_1","T"=>"VARCHAR","V"=>"","L"=>100),
			"dato_extra_2" => array("N"=>"dato_extra_2","T"=>"VARCHAR","V"=>"","L"=>100),
			"dato_extra_3" => array("N"=>"dato_extra_3","T"=>"VARCHAR","V"=>"","L"=>100),
...
class cSeguimiento_notificaciones {
	private $mCampos	= array(
			"idseguimiento_notificaciones" => array("N"=>"idseguimiento_notificaciones","T"=>"INT","V"=>"","L"=>10),
			"socio_notificado" => array("N"=>"socio_notificado","T"=>"BIGINT","V"=>"1","L"=>20),
			"numero_solicitud" => array("N"=>"numero_solicitud","T"=>"BIGINT","V"=>"1","L"=>20),
			"numero_notificacion" => array("N"=>"numero_notificacion","T"=>"INT","V"=>"1","L"=>4),
			"fecha_notificacion" => array("N"=>"fecha_notificacion","T"=>"DATE","V"=>"0000-00-00","L"=>0),
			"oficial_de_seguimiento" => array("N"=>"oficial_de_seguimiento","T"=>"INT","V"=>"1","L"=>4),
			"capital" => array("N"=>"capital","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"interes" => array("N"=>"interes","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"moratorio" => array("N"=>"moratorio","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"otros_cargos" => array("N"=>"otros_cargos","T"=>"DOUBLE","V"=>"0.00","L"=>25),
			"impuestos" => array("N"=>"impuestos","T"=>"DOUBLE","V"=>"","L"=>25),
			"total" => array("N"=>"total","T"=>"FLOAT","V"=>"0.00","L"=>25),
			"observaciones" => array("N"=>"observaciones","T"=>"VARCHAR","V"=>"","L"=>100),
			"estatus_notificacion" => array("N"=>"estatus_notificacion","T"=>"ENUM","V"=>"|pendiente|efectuado|comprometido|cancelado|vencido|","L"=>0),
			"sucursal" => array("N"=>"sucursal","T"=>"VARCHAR","V"=>"matriz","L"=>20),
			"eacp" => array("N"=>"eacp","T"=>"VARCHAR","V"=>"EN_TRAMITE","L"=>20),
			"grupo_relacionado" => array("N"=>"grupo_relacionado","T"=>"BIGINT","V"=>"99","L"=>20),
			"hora" => array("N"=>"hora","T"=>"TIME","V"=>"","L"=>0),
			"usuario" => array("N"=>"usuario","T"=>"INT","V"=>"1","L"=>11),
			"canal_de_envio" => array("N"=>"canal_de_envio","T"=>"VARCHAR","V"=>"personal","L"=>20),
			"formato" => array("N"=>"formato","T"=>"INT","V"=>"0","L"=>11),
...
class cTmp_colonias_activas {
	private $mCampos	= array(
			"codigo_postal" => array("N"=>"codigo_postal","T"=>"INT","V"=>"0","L"=>10),
			"nombre" => array("N"=>"nombre","T"=>"VARCHAR","V"=>"","L"=>100),
			"numero" => array("N"=>"numero","T"=>"BIGINT","V"=>"0","L"=>21),
			"codigo_de_estado" => array("N"=>"codigo_de_estado","T"=>"INT","V"=>"4","L"=>4),
			"codigo_de_municipio" => array("N"=>"codigo_de_municipio","T"=>"INT","V"=>"1","L"=>4),
			"nombre_municipio" => array("N"=>"nombre_municipio","T"=>"VARCHAR","V"=>"","L"=>100),
			"clave_alfanumerica" => array("N"=>"clave_alfanumerica","T"=>"VARCHAR","V"=>"CC","L"=>4),
			"nombre_estado" => array("N"=>"nombre_estado","T"=>"VARCHAR","V"=>"","L"=>60),
			"clave_en_sic" => array("N"=>"clave_en_sic","T"=>"VARCHAR","V"=>"","L"=>8),
			"idlocalidad" => array("N"=>"idlocalidad","T"=>"INT","V"=>"0","L"=>11),
			"nombre_localidad" => array("N"=>"nombre_localidad","T"=>"VARCHAR","V"=>"","L"=>100)
...
class cEacp_config_bases_de_integracion_miembros {
	private $mCampos	= array(
			"ideacp_config_bases_de_integracion_miembros" => array("N"=>"ideacp_config_bases_de_integracion_miembros","T"=>"INT","V"=>"","L"=>10),
			"codigo_de_base" => array("N"=>"codigo_de_base","T"=>"INT","V"=>"","L"=>10),
			"miembro" => array("N"=>"miembro","T"=>"INT","V"=>"","L"=>5),
			"afectacion" => array("N"=>"afectacion","T"=>"FLOAT","V"=>"1.0000","L"=>25),
			"descripcion_de_la_relacion" => array("N"=>"descripcion_de_la_relacion","T"=>"VARCHAR","V"=>"","L"=>45),
			"subclasificacion" => array("N"=>"subclasificacion","T"=>"INT","V"=>"0","L"=>6),
