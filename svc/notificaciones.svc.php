...
$todo			= parametro("todo", false, MQL_BOOL);

$rs				= array();
$rs["error"]	= true;
$rs["message"]	= "Sin datos validos";
header('Content-type: application/json');
$oficial		= ($todo == true) ? false : getUsuarioActual();
$xSVC			= new MQLService("LIST", $xLi->getListadoDeNotificaciones(false, false, SYS_TODAS, $fecha, $FechaFinal, $oficial));
